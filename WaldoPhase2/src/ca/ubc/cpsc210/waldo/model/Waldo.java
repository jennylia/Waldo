...
/*
 * getWaldos:		tracks the names of users, or waldos, who are using the service
 * postLocation: 	allows waldos to notify the service of their current location
 * getWaldoByName:	permits waldos to retrieve the locations of other waldos
 * sendMsg:			permits waldos to exchange messages in a limited fashion
 * 
 */
